...
\begin{tabularx}{\textwidth}{@{}lr}
    ...
    Bankgiro & 5807-3339 \\
\end{tabularx}
}\hfill\parbox{2.5cm}{\includegraphics[width=2.5cm]{<qrimage>}}
\end{tcolorbox}
}
...
\fancyfoot[l]{
    %\changefont
     \begin{tabularx}{\linewidth}{rlrlrl}
         ...
         \textbf{Hemsida:} & https://gen-arborist.se & \mbox{\textbf{VAT.nr.}} & SE556432616201 & \textbf{E-post:} & elias@gen-arborist.se \\
       \end{tabularx}
  }
